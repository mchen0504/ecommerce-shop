...
const NavOnHover = (props) => {
  const mouseOverShopAllOptions = () => {
    props.handleShopAllMouseEnter("mouseOnShopAllOptions");
  }

  return (
    <Container onMouseEnter={mouseOverShopAllOptions} onMouseLeave={}>
      <Left>
        <Section>
